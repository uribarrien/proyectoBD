...
<html>
    ...
    <body>
        ...
        <div id="contenedor_form" class="container col-md-6">
          ...
          <form class="needs-validation" novalidate action="php/informacion.php" method="POST">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="firstName">Cambiar contraseña (opcional)</label>
              ...
              <div class="col-md-6 mb-3">
                <label for="lastName">Reingresar contraseña</label>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="firstName">Télefono (10 digitos)</label>
                <input type="text" class="form-control" name="telefono" placeholder="" value="<?php echo $row['telefono']; ?>" >
              </div>
            </div>
