...
<html id="full">
    <head>
        ...
        <title>Chamarras para hombre</title>
            ...
            <div class="row ">
                <div class="col-md-2 h-full m-t-30">
                    <div id="menu_izq" class="container-fluid">
                        ...
                        <div class="row m-b-25 p-l-0">
                            <a id="activo" class="cl3 ltext-106 hov-cl2 trans-08" href="chamarrasH.php">CHAMARRAS</a>
                        </div>
                        <div class="row m-b-25 p-l-0">
                ...
                <div id="contenedor_imagenes" class="col-md-8 m-t-30 m-l-60">
                    ...
                    <div class="row m-t-30 m-b-30">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/abrigos/1_r.png" alt="IMG-PRODUCT">

                                    <a href="detalle_producto.php?id=15" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver chamarra
                                    </a>
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5 txt-center">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="detalle_producto.php?id=15" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                            Chamarra negra acolchada capucha
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/abrigos/2_r.png" alt="IMG-PRODUCT">

                                    <a href="detalle_producto.php?id=16" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver abrigo
                                    </a>
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="detalle_producto.php?id=16" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-5">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="detalle_producto.php?id=1" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                    ...
                    <div class="row m-b-50">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/abrigos/3_r.png" alt="IMG-PRODUCT">
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="detalle_producto.php?id=2" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/abrigos/4_r.png" alt="IMG-PRODUCT">

                                    <a href="detalle_producto.php?id=17" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver abrigo
                                    </a>
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="detalle_producto.php?id=17" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                            Abrigo cuello asimétrico
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/abrigos/6_r.png" alt="IMG-PRODUCT">
