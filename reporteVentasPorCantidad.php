...
<body>
 ...
 <tr style='height:7.95pt'>
  ...
  height:7.95pt'>
  <p class=MsoNormal style="width: 87px; height: 14px;"><b><input type="text"></b></p>
  </td>
  ...
  <tbody>
   ...
   <tr >
        ...
        <td style='border-left:solid;border-top:solid;border-bottom:solid;border-color:red;'><b>TOTAL</b></td>
          <td style='border-right:solid;border-top:solid;border-bottom:solid;border-color:red;'>2323</td>
