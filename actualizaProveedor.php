...
$datos = mysqli_query($connection, "SELECT * FROM proveedor WHERE no_proveedor = $id;");
        ...
        <div class="col-md order-md-2 mb-4">
          ...
          <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control"  id="calle" name="calle" placeholder="" value=<?php echo $data['calle']; ?> >
              </div>
                <div class="col-md mb-3">
                <label for="no_exterior">No. exterior <span class="text-muted"></span></label>
                <input type="text" name="no_exterior" class="form-control" id="no_exterior" placeholder="" value="<?php echo $data['no_exterior']; ?>">
            </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="cp" class="form-control" id="codigo_postal" placeholder="" value="<?php echo $data['codigo_postal']; ?>" >
              </div>
            </div>
        ...
        <div class="col-md order-md-1">
          ...
          <div class="needs-validation" novalidate>
            <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control" id="razonsocial" placeholder="" value="<?php echo $data['nombre_proveedor']; ?>">
            </div>

            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="rfc">RFC</label>
                <input type="text" name="rfc" class="form-control" id="rfc" placeholder="" value="<?php echo $data['rfc']; ?>" >
