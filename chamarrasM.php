                ...
                <div id="contenedor_imagenes" class="col-md-8 m-t-30 m-l-60">
                    ...
                    <div class="row m-t-30 m-b-30">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/chamarras/m8_1.jpg" alt="IMG-PRODUCT">

                                    <a href="detalle_producto.php?id=30" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver producto
                                    </a>
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5 txt-center">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="detalle_producto.php?id=30" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                            ABRIGO EFECTO PELO
                                        </a>
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/chamarras/m9_1.jpg" alt="IMG-PRODUCT">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="img_tienda/chamarras/m13_1.jpg" alt="IMG-PRODUCT">
                                <a href="detalle_producto.php?id=31" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver producto
                                    </a>

                            <div class="block2-txt flex-w flex-t p-t-5">
                                <div id="" class="block2-txt-child1 flex-col-l">
                                    <a href="detalle_producto.php?id=31" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        ABRIGO TEXTURA BORREGUILLO COLOR
                                    </a>
                    ...
                    <div class="row m-b-50">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/chamarras/m10_1.jpg" alt="IMG-PRODUCT">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/chamarras/m11_1.jpg" alt="IMG-PRODUCT">
                        ...
                        <div class="col-md-4 " >
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="img_tienda/chamarras/m12_1.jpg" alt="IMG-PRODUCT">

                                    <a href="detalle_producto.php?id=32" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Ver producto
                                    </a>
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-5">
                                    <div id="" class="block2-txt-child1 flex-col-l">
                                        <a href="detalle_producto.php?id=32" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
